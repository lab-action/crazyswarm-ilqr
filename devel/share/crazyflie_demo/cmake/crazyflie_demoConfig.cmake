...
if("TRUE" STREQUAL "TRUE")
  set(crazyflie_demo_SOURCE_PREFIX /home/ayberk/Documents/ACTIONLAB/crazyswarm/ros_ws/src/crazyflie_ros/crazyflie_demo)
  set(crazyflie_demo_DEVEL_PREFIX /home/ayberk/Documents/ACTIONLAB/crazyswarm/ros_ws/devel)
  ...
  set(crazyflie_demo_INSTALL_PREFIX /home/ayberk/Documents/ACTIONLAB/crazyswarm/ros_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'crazyflie_demo' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ayberk/Documents/ACTIONLAB/crazyswarm/ros_ws/src/crazyflie_ros/crazyflie_demo/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT crazyflie_demo_NUM_DUMMY_TARGETS)
      set(crazyflie_demo_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::crazyflie_demo::wrapped-linker-option${crazyflie_demo_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR crazyflie_demo_NUM_DUMMY_TARGETS "${crazyflie_demo_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::crazyflie_demo::wrapped-linker-option${crazyflie_demo_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND crazyflie_demo_LIBRARIES "${interface_target_name}")
